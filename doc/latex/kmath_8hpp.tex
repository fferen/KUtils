...
float \hyperlink{namespacekmath_af21fdb579807bd7054875a2369e15941}{kmath\-::interval\-Project} (float val, const Interval \&domain, const Interval \&range, const function$<$ float(float)$>$ \&func=\mbox{[}$\,$\mbox{]}(float x)\{return x;\}, const Interval \&func\-Domain=Interval(0, 1), const Interval \&func\-Range=Interval(0, 1))
