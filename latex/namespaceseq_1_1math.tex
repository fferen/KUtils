...
Construct a sequence of numbers from {\ttfamily low} to {\ttfamily high} with optional {\ttfamily step}, store it in {\ttfamily out}, and return {\ttfamily out}. 
...
Construct a sequence of numbers from 0 to high with step=1, store it in {\ttfamily out}, and return {\ttfamily out}. 
